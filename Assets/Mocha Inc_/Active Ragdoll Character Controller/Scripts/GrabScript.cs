...
namespace ActiveRagdoll
{
    public class GrabScript : MonoBehaviour
    {
        ...
        public void dropObject()
        {
            ...
            {
                Destroy(grabJoint);
                heldObject.GetComponent<Rigidbody>().velocity =
                    heldObject.GetComponent<Rigidbody>().velocity * throwMultiplier;
                heldObject = null;
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            if (isLeftArm)
            {
                //if (Input.GetMouseButton(0) && other.gameObject.GetComponent<Rigidbody>() != null &&
                if (other.gameObject.GetComponent<Rigidbody>() != null &&
                    other.gameObject.tag != "Player" &&
                    (other.gameObject.tag == "grabbable" || other.gameObject.tag == "gun"))
                {
            ...
            // else
            // {
            //     if (Input.GetMouseButton(1) && other.gameObject.GetComponent<Rigidbody>() != null &&
            //         other.gameObject.tag != "Player" &&
            //         (other.gameObject.tag == "grabbable" || other.gameObject.tag == "gun"))
            //     {
            //         if (other.gameObject.tag == "gun")
